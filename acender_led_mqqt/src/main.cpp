//Inicalizacao de Bibliotecas

#include <Arduino.h>
#include <ESP8266WiFi.h>
#include <PubSubClient.h>//Biblioteca de comunicacao do MQQT
...
const char *ssid  = "profbru"; //ssid = nomeRede
const char *password = "12345678"; //senhaRede
...
// Tópico para receber comandos (Dependendo da ativ vai mudar)
const char *topic_led_control = "labCarolYas";
...
void lerJson(const String &message)
{
  ...
  if (error)
  {
   ...
   // Verifica se a chave "comando" existe no JSON = O nome  COMANDO pode ser adptado, conforme a ativ
...
//Função que dispara quando recebe uma mensagem
